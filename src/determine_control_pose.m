...
% This function orients the robot towards a goal point (second waypoint)
% by adjusting its theta then when within a certain tolerance implements
% the pure pursuit procedure to drive to the goal point.  Once within a
% certain distance it then turns to face it's target pose.
